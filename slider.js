$(document).ready(function() {
    ...
    {
        sliderHtml += "<div id='slider-container' style='display:flex;flex-direction:row;overflow:hidden;background-color:black;'>"
        ...
        sliderHtml += "</div>"
        sliderHtml += "<button style='background-color:transparent;border:none;font-size:50px;color:purple;' data-action='left'><</button>"; //left button
        sliderHtml += "<button style='background-color:transparent;border:none;font-size:50px;color:green;' data-action='right'>></button>"; //right button
